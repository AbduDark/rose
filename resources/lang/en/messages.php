...
return [
    ...
    'auth' => [
        ...
        'verification_pin_sent' => 'Verification PIN sent to your email',
    ...
    // Favorite messages
    'favorites' => [
        'added_successfully' => 'Course added to favorites',
        'removed_successfully' => 'Course removed from favorites',
    ],

    // Payment messages
    'payments' => [
        'submitted_successfully' => 'Payment submitted successfully',
        'accepted_successfully' => 'Payment accepted successfully',
        'rejected_successfully' => 'Payment rejected',
    ],
